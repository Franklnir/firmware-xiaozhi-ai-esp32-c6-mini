...
void LcdDisplay::SetupUI() {
    ...
    lv_obj_set_style_pad_left(top_bar_, lvgl_theme->spacing(12), 0);
    lv_obj_set_style_pad_right(top_bar_, lvgl_theme->spacing(12), 0);
...
#if CONFIG_BOARD_TYPE_ESP32_C6_SUPER_MINI
#define  MAX_MESSAGES 8
#define  CHAT_SCROLL_ANIM LV_ANIM_OFF
#elif CONFIG_IDF_TARGET_ESP32P4
#define  MAX_MESSAGES 40
#define  CHAT_SCROLL_ANIM LV_ANIM_ON
#else
...
void LcdDisplay::SetChatMessage(const char* role, const char* content) {
    ...
    if (strcmp(role, "user") == 0) {
        ...
        lv_obj_scroll_to_view_recursive(container, CHAT_SCROLL_ANIM);
    } else if (strcmp(role, "system") == 0) {
        ...
        lv_obj_scroll_to_view_recursive(msg_bubble, CHAT_SCROLL_ANIM);
    }
